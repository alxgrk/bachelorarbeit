...
public class AccountControllerITest {
    ...
    public void testAccountsFound() throws Exception {
        mockMvc.perform(post("/accounts/get-all"))
    ...
    public void testAccountFound() throws Exception {
        mockMvc.perform(post("/accounts/get-one").param("accountId", idOne.toString()))
                .andExpect(status().isOk())
                .andExpect(content().contentType(contentTypeJson))
    ...
    public void testAccountCreated() throws Exception {
        mockMvc.perform(post("/accounts/create").contentType(contentTypeJson)
                .content("{"
                        + "     \"name\": \"test\","
                        + "     \"surname\": \"user\","
                        + "     \"username\": \"test\","
    ...
    public void testAccountUpdated() throws Exception {
        mockMvc.perform(post("/accounts/update").param("accountId", idOne.toString())
    ...
    public void testAccountNotFound() throws Exception {
        mockMvc.perform(post("/accounts/update").param("accountId", "123456")
                .contentType(contentTypeJson)
                .content("{"
                        + "     \"name\": \"test\","
                        + "     \"surname\": \"user\","
    ...
    public void testAccountDeleted() throws Exception {
        mockMvc.perform(post("/accounts/delete").param("accountId", idOne.toString()))
