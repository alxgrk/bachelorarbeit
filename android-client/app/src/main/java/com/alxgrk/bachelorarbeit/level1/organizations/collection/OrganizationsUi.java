...
import com.alxgrk.bachelorarbeit.level1.organizations.OrganizationFragment;
...
class OrganizationsUi {
    ...
    private void processSelfLink(Organization org, ConstraintLayout result) {
        ...
        entryLayout.setOnClickListener(v -> {
            sharedUi.getFragment().switchTo(OrganizationFragment.newInstance(entryUrl + "orgs/get-one?orgId=" + org.getId()));
        });
    }
