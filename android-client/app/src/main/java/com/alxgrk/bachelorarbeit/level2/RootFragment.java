...
import com.alxgrk.bachelorarbeit.level2.organizations.collection.OrganizationsFragment;
...
public class RootFragment extends AbstractFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewContainer,
        ...
        String entryUrl = prefs.getString(SettingsActivity.ENTRY_URL_KEY_2, SettingsActivity.ENTRY_URL_DEFAULT_2);
        ...
        accountsButton.setOnClickListener(v -> {
            switchTo(AccountsFragment.newInstance(entryUrl + "accounts"));
        });
        ...
        orgsButton.setOnClickListener(v -> {
            switchTo(OrganizationsFragment.newInstance(entryUrl + "orgs"));
        });
        ...
        resButton.setOnClickListener(v -> {
            switchTo(ResourcesFragment.newInstance(entryUrl + "resources"));
        });
